<?php
    ...
    class Googlemaps_UpdateUser_AsyncAction extends Basic_Abstract_AsyncAction
    {
        ...
        public function perform($_domainId = null, array $_params = array())
        {
            ...
            $address_geo = $country.'+'.$city.'+'.$street.'+'.$house;
            ...
            }else{throw new AsyncActionException('Can`t get coordinats! Iput correct address!');}
            ...
            $mySql->update('google_maps_users', array('name'=>$nameStr,'index'=>$index, 'country'=>$country, 'city'=>$city,
                'street'=>$street,'house'=>$house, 'lat'=>$lat,'lng'=>$lng), array('id' => $id));
